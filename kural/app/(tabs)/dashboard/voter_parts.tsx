...
const styles = StyleSheet.create({
  ...
  partsModalContent: { backgroundColor: '#FFFFFF', borderRadius: 0, padding: 20, width: '95%', height: '80%', maxWidth: 500 },
  ...
  colorModalCard: { backgroundColor: '#FFFFFF', borderRadius: 0, padding: 20, width: '90%', maxWidth: 420, alignItems: 'center' },
