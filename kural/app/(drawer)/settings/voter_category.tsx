        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <View style={styles.modalIconContainer}>
              {selectedCategory && renderCategoryIcon(selectedCategory.icon, selectedCategory.color)}
            </View>
            ...
            <View style={styles.modalButtons}>
              ...
              >
                {saving ? (
                  ...
                  <Text style={styles.saveButtonText}>{t('voterCategory.save')}</Text>
                )}
              </TouchableOpacity>
