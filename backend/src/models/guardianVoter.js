...
const GuardianVoterSchema = new mongoose.Schema({
  Name: { type: String },
...
}, { timestamps: true, versionKey: false, collection: 'gurdian' });

module.exports = mongoose.model('GuardianVoter', GuardianVoterSchema);
