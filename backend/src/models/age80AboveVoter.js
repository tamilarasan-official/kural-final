...
const Age80AboveVoterSchema = new mongoose.Schema({
  Name: { type: String },
...
}, { timestamps: true, versionKey: false, collection: '80 and above' });

module.exports = mongoose.model('Age80AboveVoter', Age80AboveVoterSchema);
